...
img = cv2.imread("/Users/pcy/Desktop/무제 폴더/aa.png")  # 이미지 읽기
...
ECB_encrypted_img = DES_ECB(img_arr, [1,2,3,4,5,6,7,8], round=1)
CBC_encrypted_img = DES_CBC(img_arr, [1,2,3,4,5,6,7,8], round=1)
OFB_encrypted_img = DES_OFB(img_arr, [1,2,3,4,5,6,7,8], round=1)

CBC_decrypted_img = DES_CBC_decrypt(CBC_encrypted_img, [1,2,3,4,5,6,7,8], round=1)
